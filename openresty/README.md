...
[![Docker Pulls](https://img.shields.io/docker/pulls/c18s/openresty.svg?logo=docker)][dockerhub]
[![Docker Image Size](https://img.shields.io/docker/image-size/c18s/openresty/latest?logo=docker)][dockerhub_tag]
